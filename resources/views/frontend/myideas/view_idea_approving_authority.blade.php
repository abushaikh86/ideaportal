        ...
        <div class="row align-items-end">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Back" @if (session()->has('main_page')) href="{{ session('main_page') }}" @else href="{{ route('ideas.index') }}"> @endif>
                        ...
                        <div class="col-lg-7 col-12">
                            ...
                            <div class="list">
                                ...
                                <div class="item">
                                    ...
                                    <div class="content">
                                        @if (isset($assessment_journey->remarks) && !is_null($assessment_journey->remarks))
                                            <p class="mb-3">Assessment User Response {{ $assessment_journey->remarks }} </p>
                                        @endif

                                        {{ Form::text('remarks',(isset($journey_approver->remarks)?$journey_approver->remarks:null), ['class'=>'form-control','id'=>'remarks','placeholder'=>'Enter Remarks']) }}
                                    </div>
                                </div>
                                @endif
                                ...
                                @if ($role != 'User')
                                    <div class="form_container chat-form" style="position: relative;">
                                        <form method="POST" action="{{ route('ideas.storeSupportingdocs') }}" enctype="multipart/form-data" class="row align-items-end">
                                            @csrf
                                            <div class="col-lg-6">
                        ...
                        @if (count($feedback) > 0)
                            @foreach ($feedback as $fb)
                                ...
                                @if (Auth::id() == $fb['user_id'] && $fb['user_role'] !== 'admin')
                                    ...
                                    @endphp
                                @endif
                                <div class="users-img mb-3" style="display:flex !important;justify-content: flex-start;align-items:center; {{ $style }}">
                                    <div class="{{ $class_idea_discussion }}" style="display:flex;flex-direction:column;justify-content:space-between;{{ $style2 }}">
                                        <h4>
                                            <strong>
