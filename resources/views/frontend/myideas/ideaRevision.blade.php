        ...
        <div class="row align-items-end">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Back" @if (session()->has('main_page')) href="{{ session('main_page') }} " @else href="{{ route('myideas.index') }}" @endif>
                        ...
                        <table class="table zero-configuration m-0 p-0" id="tbl-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/myideas/viewIdeaRevision',$idea->idea_revision_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @php
                                $srno++;
