        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('myideas.index') }}">My Ideas</a>
                    </li>
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Back" href="{{ route('myideas.index') }}">
        ...
        <div id="basic-datatable">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Form -->
                    {{ Form::model($idea,[ 'method' => 'POST', 'url' => ['myideas/update'], 'files'=> true ]) }}
                    @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            {{ Form::submit('Update', array('class' => 'btn btn-primary mr-1 mb-1','id'=>'submit')) }}
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card border-0 shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a style="margin:5px 5px 5px 0px;" href="{{$img_path}}" class="btn btn-sm btn-primary" target="_new">Download</a>
                                        @else
