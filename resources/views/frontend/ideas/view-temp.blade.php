                        ...
                        <div id="idea_status">
                            ...
                            @if($roles_external->role_type == 'User')
                                ...
                                @elseif($roles_external->role_type == 'Assessment Team')
                                    <?php $data = FacadesDB::table('ideas')->where(['idea_id'=>$idea->idea_id,'assessment_team_approval'=>1])->first(); ?>
                                    @if(!empty($data))
                                        ...
                                        @endforeach
                                    @endif
                                        <?php $data=  FacadesDB::table('ideas')->where('idea_id',$idea->idea_id)->first(); ?>
