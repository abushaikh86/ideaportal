...
@section('title', 'Edit File Setting')
@php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            {{-- {{ Form::select('allowed_extetnsion', $extensions, $extensions, ['class' => 'select2 form-control', 'placeholder' => 'Select Extension', 'required' => true]) }} --}}
                                        </div>
                                    </div>
