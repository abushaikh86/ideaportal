...
@section('title', 'Approver/Assessment Team wise Idea Analysis Statistics')
...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Approver/Assessment Team wise Idea Analysis Statistics</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Approver/Assessment Team wise Idea Analysis Statistics</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            var table = $('#tbl-datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.teamwiseanalysis') }}",
                    type: "GET",
                    data: function(d) {
