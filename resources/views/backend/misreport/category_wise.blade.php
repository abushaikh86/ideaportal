...
@section('title', 'Idea Category wise Reports')
...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Idea Category wise Reports</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Idea Category wise Reports</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('category_id', $category_data, request('category_id'), ['placeholder' => 'Select Category', 'class' => 'form-control category_id']) }}
                                        </div>
                                    </div>
