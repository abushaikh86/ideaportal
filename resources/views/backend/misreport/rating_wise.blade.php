...
@section('title', 'Ratings wise Idea Status')
...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Ratings wise Idea Status</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Ratings wise Idea Status</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('rating', array_combine(range(1, 10), range(1, 10)), request('rating'), ['id' => 'rating', 'placeholder' => 'Select Rating', 'class' => 'form-control']) }}
                                        </div>
                                    </div>
