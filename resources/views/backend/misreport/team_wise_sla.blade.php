...
@section('title', 'Approver/Assessment Team wise SLA Met/Missed')
...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Approver/Assessment Team wise SLA Met/Missed</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Approver/Assessment Team wise SLA Met/Missed</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select(
                                                ...
                                                request('team'),
                                                ['id' => 'team', 'placeholder' => 'Select Team', 'class' => 'form-control'],
                                            ) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            {{ Form::label('sla_status', 'SLA Status') }}
                                            {{ Form::select(
                                                'sla_status',
                                                [
                                                    'met' => 'Met',
                                                ...
                                                request('sla_status'),
                                                ['id' => 'sla_status', 'placeholder' => 'Select SLA Status', 'class' => 'form-control'],
                                            ) }}
                                        </div>
                                    </div>
    ...
    <script>
        $(function() {
            ...
            var table = $('#tbl-datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.teamwisesla') }}",
                    type: "GET",
                    data: function(d) {
                        d.company_id = $('select[name="company_id"]').val();
                        d.team = $('select[name="team"]').val();
                        d.sla_status = $('select[name="sla_status"]').val();
                    }
                },
                ...
                columns: [{
                    ...
                    {
                        data: 'sla_reason_assessment',
                        name: 'sla_reason_assessment',
