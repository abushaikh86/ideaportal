                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12" style="margin-bottom:20px !important;">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('role_type',[''=>'Select Role','User'=>'User',
                                    ...
                                    <div class="col-md-12 col-12 internal-user">
                                        <h4 class="card-title">
                                            <div class="checkbox checkbox-primary">
                                                {{ Form::checkbox('menu_values[]', 'menu_values', null,
                                                ['id'=>'menu_values']) }}
                                            ...
                                            <div class="col-md-12 col-12 mt-2 menu_permissions">
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="d-inline-block mr-2 mb-1">
                                                        <fieldset>
                                                            <div class="checkbox checkbox-primary">
                                                                {{ Form::checkbox('menu_values[]', $item, null,
                                                                ['id'=>'menu_values['.$item.']']) }}
                                    ...
                                    <div class="col-md-12 col-12 internal-user">
                                        <h4 class="card-title">
                                            <div class="checkbox checkbox-primary">
                                                {{ Form::checkbox('button_values[]', 'button_values', null,
                                                ['id'=>'Buttons']) }}
                                                {{ Form::label('Buttons') }}
                                            </div>
                                        </h4>
                                            ...
                                            <div class="col-md-12 col-12 mt-2 menu_permissions">
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="d-inline-block mr-2 mb-1">
                                                        <fieldset>
                                                            <div class="checkbox checkbox-primary">
                                                                {{ Form::checkbox('button_values[]', $item, null,
                                                                ['id'=>'button_values['.$item.']']) }}
