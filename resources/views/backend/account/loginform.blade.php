    ...
    <section class="admin-panel">
        <div class="container">
            <div class="card shadow border-0 rounded-0">
                <div class="image">
                    <img src="{{ asset('public/backend-assets/images/logo/jm-baxi5.webp') }}" class="img-fluid" />
                </div>
                <div class="form">
                    <img src="{{ asset('public/backend-assets/images/logo/index.png') }}" class="img-fluid mb-3" />
                    ...
                    <form method="POST" action="{{ route('admin.login.submit') }}">
                        ...
                        <div class="form-group">
                            ...
                            <a class="message text-primary" style="text-decoration: underline!important;" href="{{ route('admin.forgot_password') }}">Forgot Password</a>
                        </div>
