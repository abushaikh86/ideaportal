        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-end">
            ...
            <div class="dashboard-content-right">
              <img src="{{ asset('public/backend-assets/images/icon/cup.png') }}" height="220" width="220" class="img-fluid"
              ...
              <tbody>
                  ...
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-10.jpg') }}" alt="avatar"
                ...
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
                ...
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-12.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
              ...
              <tbody>
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-9.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
              ...
              <tbody>
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-25.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
                ...
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-15.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
                        <h6 class="media-heading mb-0">Pauly Dez</h6>
              ...
              <tbody>
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-16.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
                ...
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-1.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
                        <h6 class="media-heading mb-0">Pauly Dez</h6>
                ...
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-2.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
              ...
              <tbody>
                <tr>
                  <td class="pr-75">
                    <div class="media align-items-center">
                      <a class="media-left mr-50" href="#">
                        <img src="{{ asset('public/backend-assets/images/portrait/small/avatar-s-19.jpg') }}" alt="avatar"
                          class="rounded-circle" height="30" width="30">
                      </a>
                      <div class="media-body">
