...
use App\Http\Controllers\backend\SlaController;
use App\Http\Controllers\backend\MisreportController;
use App\Http\Controllers\backend\FilesettingController;
...
Route::get('/user/logout/timeout', [UserController::class, 'logouttimeout'])->name('user.logout.time');
...
Route::get('/all/ideas', [IdeaController::class, 'show_all_ideas'])->name('all.ideas');
...
Route::get('/ideas/view/{id}/{view_mode?}', [IdeaController::class, 'view'])->name('ideas.view');
...
Route::post('idea/rejectidea/implementor', [IdeaController::class, 'reject_idea_implementor'])->name('reject_idea_implementation_team');

// Get chart values
Route::get('/ideas/getChartValues', [IdeaController::class, 'getChartValues'])->name('ideas.getChartValues');

// usama_14-02-2024 to get chat messages
Route::post('/getChatMessages',  [IdeaController::class, 'getChatMessages'])->name('getChatMessages');
Route::post('/getUserDetails',  [IdeaController::class, 'getUserDetails'])->name('getUserDetails');

Route::post('/ideas/feedback', [IdeaController::class, 'storeFeedback'])->name('ideas.storeFeedback');
Route::post('/ideas/supportingdocs', [IdeaController::class, 'storeSupportingdocs'])->name('ideas.storeSupportingdocs');
...
//Route::post('/ideas/idea_implemented', [IdeaController::class, 'idea_implemented'])->name('ideas.idea_implemented');
Route::any('/ideas/rating', [IdeaController::class, 'rating'])->name('ideas.rating');
Route::post('ideas/approvewith/budget', [IdeaController::class, 'ApproveIdeaWithBudget'])->name('ideaApproveWithbudget');
Route::post('ideas/update/budgetdetails', [IdeaController::class, 'UpdateBudgetDetails'])->name('ideaupdatebudgetdetails');


//assesment user update selectbox values
Route::post('/ideas/updateidea/assessment/confirmations', [IdeaController::class, 'updateIdeaConfirmation'])->name('ideas.assessment.update.confirmation');
Route::post('/ideas/updateidea/approver/confirmations', [IdeaController::class, 'updateIdeaConfirmationApprover'])->name('ideas.assessment.update.confirmation');
Route::post('/ideas/updateidea/assessment/likedislike', [IdeaController::class, 'LikeDislike'])->name('ideas.assessment.like.dislike');
...
Route::post('ideas/ajax_clear_notification', [NotificationController::class, 'ajax_clear_notification'])->name('ideas.ajax_clear_notification');
Route::get('user/notifications/show', [NotificationController::class, 'show_all_notification'])->name('user.all.notification');
...
Route::POST('ajax/get/employees', [CompanyController::class, 'getEmployees'])->name('ajax.get.employees');
...
Route::prefix('admin')->group(function () {
  ...
  Route::group(['middleware' => 'admin.auth'], function () {
    ...
    Route::get('/logout/timeout', [AccountController::class, 'logouttimeout'])->name('admin.logout.time');
    ...
    Route::post('ideas/ajax_clear_notification', [AdminNotificationController::class, 'ajax_clear_notification'])->name('ideas.ajax_clear_notification');
    Route::get('notifications/show', [AdminNotificationController::class, 'show_all_notification'])->name('admin.all.notification');
    ...
    // for sla
    Route::get('/sla', [SlaController::class, 'index'])->name('admin.sla');
    Route::get('/sla/create', [SlaController::class, 'create'])->name('admin.sla.create');
    Route::post('/sla/store', [SlaController::class, 'store'])->name('admin.sla.store');
    Route::get('/sla/edit/{id}', [SlaController::class, 'edit'])->name('admin.sla.edit');
    Route::post('/sla/update', [SlaController::class, 'update'])->name('admin.sla.update');
    Route::get('/sla/delete/{id}', [SlaController::class, 'destroy'])->name('admin.sla.delete');


    //for mis report
    Route::any('/leaderboard', [MisreportController::class, 'leaderboard'])->name('admin.leaderboard');
    Route::any('/group_wise', [MisreportController::class, 'group_wise'])->name('admin.group_wise');
    Route::any('/teamwiseanalysis', [MisreportController::class, 'teamwiseanalysis'])->name('admin.teamwiseanalysis');
    Route::any('/teamwisesla', [MisreportController::class, 'teamwisesla'])->name('admin.teamwisesla');
    Route::any('/group_wise_budget', [MisreportController::class, 'group_wise_budget'])->name('admin.group_wise_budget');
    Route::any('/apprv_not_implemented', [MisreportController::class, 'apprv_not_implemented'])->name('admin.apprv_not_implemented');
    Route::any('/category_wise', [MisreportController::class, 'category_wise'])->name('admin.category_wise');
    Route::any('/budget_wise', [MisreportController::class, 'budget_wise'])->name('admin.budget_wise');
    Route::any('/rating_wise', [MisreportController::class, 'rating_wise'])->name('admin.rating_wise');


    //for file setting
    Route::get('/filesetting', [FilesettingController::class, 'index'])->name('admin.filesetting');
    Route::get('/filesetting/create', [FilesettingController::class, 'create'])->name('admin.filesetting.create');
    Route::post('/filesetting/store', [FilesettingController::class, 'store'])->name('admin.filesetting.store');
    Route::get('/filesetting/edit/{id}', [FilesettingController::class, 'edit'])->name('admin.filesetting.edit');
    Route::post('/filesetting/update', [FilesettingController::class, 'update'])->name('admin.filesetting.update');
    Route::get('/filesetting/delete/{id}', [FilesettingController::class, 'destroy'])->name('admin.filesetting.delete');
