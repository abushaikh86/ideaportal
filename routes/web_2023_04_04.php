...
Route::prefix('admin')->group(function () {
  ...
  Route::group(['middleware' => 'admin.auth'], function () {
    ...
    Route::get('/idea/delete/{id}', [IC::class, 'distroyIdea'])->name('admin.idea.distroyIdea');
  ...
  // For notifications
    Route::get('/ideas/ajax_get_notifications', [AdminNotificationController::class, 'ajax_get_notifications'])->name('admin.ideas.ajax_get_notifications');
    Route::get('/ideas/ajax_update_notification/{notification_id}/{idea_id}', [AdminNotificationController::class, 'ajax_update_notification'])->name('admin.ideas.ajax_update_notification');
