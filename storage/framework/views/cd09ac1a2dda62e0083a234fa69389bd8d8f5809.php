...
<?php $__env->startSection('title', 'Idea Management'); ?>
        ...
        $(function() {
            ...
            var table = $('#tbl-datatable').DataTable({
                ...
                ajax: {
                    ...
                    url: "<?php echo e(route('admin.ideaManagement')); ?>",
                    type: "GET",
                    data: function(d) {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ideaportal\resources\views/backend/ideaManagement/ideaManagement.blade.php ENDPATH**/ ?>