                                                    ...
                                                    <div id="card-body">
                                                        ...
                                                        <div class="idea-status-box mb-2 mt-3 mx-2">
                                                            ...
                                                            <select class="form-control me-2" id="idea_status"
                                                                ...
                                                                <?php $__currentLoopData = $idea_active_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <option
                                                                        <?php echo e($idea['active_status'] == $key ? 'selected' : ''); ?>

                                                                        <?php echo e($key == 'pending' ? 'disabled' : ''); ?>

                                                                        value="<?php echo e($key); ?>"><?php echo e($status_option); ?>
                                                            ...
                                                            <input type="hidden" value="<?php echo e($role); ?>"
                                                                name="role">
                                                        ...
                                                        <div id="content1" style="display:flex;height:50px;"
                                                            ...
                                                            <input type="text" id="reason_resubmit"
                                                                ...
                                                                <?php if(isset($idea->resubmit_reason) && !is_null($idea->resubmit_reason)): ?> value="<?php echo e($idea->resubmit_reason); ?>" <?php endif; ?>><br>

                                                            <input type="text" id="reason_reject" name="reject_reason"
                                                                class="form-control w-100 mb-1 mt-1"
                                                                placeholder="Enter you reason here"
                                                                <?php if(isset($idea->reject_reason) && !is_null($idea->reject_reason)): ?> value="<?php echo e($idea->reject_reason); ?>" <?php endif; ?>><br>
                                                        </div>
                                                        <div id="content" style="display:flex;height:50px;"
                                                            ...
                                                            <input type="text" id="reason_sla" name="sla_reason"
                                                                ...
                                                                <?php if(isset($idea->sla_reason_assessment) && !is_null($idea->sla_reason_assessment)): ?> value="<?php echo e($idea->sla_reason_assessment); ?>" <?php endif; ?>>
                                                        </div>
                                ...
                                <div class="list">
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'assessment team'): ?>
                                                <div class="action-btn">
                                                    ...
                                                    <button
                                                        ...
                                                        data-idea-id="<?php echo e($idea->idea_id); ?>"
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'assessment team'): ?>
                                                <div class="action-btn">
                                                    ...
                                                    <button
                                                        ...
                                                        data-idea-id="<?php echo e($idea->idea_id); ?>"
                                                        data-user-id=<?php echo e($idea->user_id); ?> data-name='assessment_outcome'
                                                        data-btn-name='like'>
                                                        <i class="fa fa-thumbs-up"></i>
                                                    </button>
                                                    <button
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'assessment team'): ?>
                                                <div class="action-btn">
                                                    ...
                                                    <button
                                                        ...
                                                        data-idea-id="<?php echo e($idea->idea_id); ?>"
                                                        data-user-id=<?php echo e($idea->user_id); ?> data-name='benifits'
                                                        data-btn-name='like'>
                                                        <i class="fa fa-thumbs-up"></i>
                                                    </button>
                                                    <button
                                    ...
                                    <?php if(strtolower($roles_external->role_type) == 'assessment team'): ?>
                                        <div class="item">
                                            ...
                                            <div class="content">
                                                <?php echo e(Form::text('remarks', isset($journey_assesment->remarks) ? $journey_assesment->remarks : null, ['class' => 'form-control', 'id' => 'remarks', 'placeholder' => 'Enter Remarks'])); ?>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <div class="chat-section">
                        <?php
                            $feedback = Feedback::where(['user_id' => Auth::id(), 'idea_id' => request('id')])
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            // usama_13-02-2024-on user change get chats
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ideaportal/resources/views/frontend/ideas/view.blade.php ENDPATH**/ ?>