            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                <ul class="navbar-nav navbar-nav-left">
                    <li>
                        ...
                        <img src="<?php echo e(asset('public/backend-assets/images/jm-main-logo.png')); ?>" class="img-fluid logo-img">
                ...
                <ul class="navbar-nav navbar-nav-right" id="NavBar">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                            <span class="nav-profile-name"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></span></span>
                            <span class="online-status"></span>

                            <img src="<?php echo e(asset('public\backend-assets\images\dummy.png')); ?>" class="img-fluid">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="<?php echo e(route('admin.profile',['id' => $user_id])); ?>">
                                <i class="mdi mdi-account-settings text-primary"></i>
                                Profile
                            </a>
                            <a class="dropdown-item" href="<?php echo e(route('admin.changepassword')); ?>">
            ...
            <ul class="nav page-navigation">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <span class="menu-title"><?php echo e($menu->menu_name); ?></span>
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            ...
                            ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e($suburl); ?>"><?php echo e($submenu->submenu_name); ?></a>
                            </li>
                            <?php
                            }
                            ?>
...
<!-- END: Header-->
<?php /**PATH /var/www/html/ideaportal/resources/views/backend/includes/header.blade.php ENDPATH**/ ?>