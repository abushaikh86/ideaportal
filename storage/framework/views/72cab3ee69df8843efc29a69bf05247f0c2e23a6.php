        ...
        <div id="basic-datatable">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <?php echo e(Form::model($idea,[ 'method' => 'POST', 'url' => ['myideas/update'], 'files'=> true ])); ?>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <?php echo e(Form::submit('Update', array('class' => 'btn btn-primary mr-1 mb-1','id'=>'submit'))); ?>
                    ...
                    <?php else: ?>
                    <div>
                        <h2 class="sub-heading mt-2">Images not uploaded yet</h2>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/idea_portal/resources/views/frontend/myideas/updateIdea.blade.php ENDPATH**/ ?>