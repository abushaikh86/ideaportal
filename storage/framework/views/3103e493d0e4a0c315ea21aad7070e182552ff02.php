...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title" style="font-weight: 900;">Role </h3>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <?php endif; ?> -->
                                            <a href="<?php echo e(url('admin/roles/edit/'.$role->id)); ?>" class="btn btn-darkblue"><i class="feather icon-edit-2"></i></a>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ideaportal\resources\views/backend/roles/index.blade.php ENDPATH**/ ?>