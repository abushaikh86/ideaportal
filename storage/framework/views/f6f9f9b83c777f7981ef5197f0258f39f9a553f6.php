        ...
        <div class="row align-items-end">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Back" <?php if( URL::previous() != ''): ?> href="<?php echo e(URL::previous()); ?>" <?php else: ?> href="<?php echo e(route('myideas.index')); ?>" <?php endif; ?>>
                                ...
                                <div class="card status-card mt-4">
                                    <div class="card-header">
                                     ...
                                     <?php $status = 'implementation';  ?>
                                        ...
                                        <?php $status = 'under approving authority';  ?>
                                        <?php elseif($idea->active_status == 'pending'): ?>
                                        <?php $status = 'pending' ; ?>
                                        <?php elseif($idea->active_status == 'on_hold'): ?>
                                        <?php $status = 'on hold';  ?>
                                        <?php elseif($idea->active_status == 'in_assessment'): ?>
                                        <?php $status = 'in assessment';  ?>
                        ...
                        <div class="col-md-7 col-12">
                            <div class="list">
                                <div class="item">
                                    ...
                                    <div class="content">
                                        <p class="mb-3">
                                            <?php echo e((isset($idea->desription)?$idea->desription:null)); ?>
                                            ...
                                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    <div class="card border-0 shadow">
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text mb-2"><?php echo e($image->file_name); ?></p>
                                                            <a href="<?php echo e(route('ideas.delete_image', ['id' => $image->image_id])); ?>" class="btn btn-sm btn-danger cross-image remove" onclick="return confirm('Are you sure you want to delete this File')">Remove</a>
                                                            <?php if($ext == 'doc' || $ext == 'pdf' || $ext == 'docx' || $ext == 'xlsx' || $ext == 'txt'): ?>
                                                                <a href="<?php echo e($file_path); ?>" class="btn btn-sm btn-primary <?php echo e($ext == 'pdf' || $ext == 'doc' || $ext == 'xlsx' || $ext == 'txt' || $ext == 'docx' ? '' : 'test-popup-link'); ?>" target="_blank">View</a>
                                                            <?php elseif($ext === 'mp4' || $ext === 'mov' || $ext === 'avi'): ?>
                                                                <a href="<?php echo e($file_path); ?>" class="btn btn-sm btn-primary <?php echo e($ext === 'mp4' || $ext === 'mov' || $ext === 'avi' ? '' : 'test-popup-link'); ?>" target="_blank">View</a>
                                                            <?php else: ?>
                                                                <a href="<?php echo e($img_path); ?>" class="btn btn-sm btn-primary test-popup-link">View</a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <?php if($idea->implemented == 1 && $idea->active_status == 'implemented'): ?>
                                ...
                                <div class="d-flex flex-column align-items-end mt-3">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo e(route('rewards.view',['id'=>$idea->idea_id])); ?>">View Certificate</a>
                                </div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo e(route('myideas.idea_implemented',['id'=>$idea->idea_id,'role'=>$role])); ?>"
...
<div class="modal fade" id="approveForCertificateModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="<?php echo e(route('myideas.approve_certificate',['id'=>$idea->idea_id])); ?>"
                    class="btn btn-primary">Yes</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/idea_portal/resources/views/frontend/myideas/view_idea_implementation_team.blade.php ENDPATH**/ ?>