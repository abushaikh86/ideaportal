        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('myideas.index')); ?>">My Ideas</a>
                    </li>
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Back" href="<?php echo e(route('myideas.index')); ?>">
        ...
        <div id="basic-datatable">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="error_message" class="form-group mb-0">
                    ...
                    <!-- Form -->
                    <?php echo e(Form::open(['url' => url('/myideas/storeIdea'),'method'=>'POST','files' => true])); ?>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-6">
                            <div class="form-group mb-0">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-6">
                            <div class="form-group mb-0">
                                ...
                                <?php echo e(Form::select('benifits[]',$benifits ,null, ['class' =>
                                'form-control',
                                'rows'=>'4',
                                'required'
                        ...
                        <div class="col md-12">
                            ...
                            <?php echo e(Form::submit('Add', array('class' => 'btn btn-primary mr-1
                            mb-1','id'=>'submit'))); ?>

                            <button type="reset" class="btn btn-dark mr-1 mb-1" id="reset_file">Reset</button>
                        </div>
                    </div><div id='hidden_files'></div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/idea_portal/resources/views/frontend/myideas/addIdea_new.blade.php ENDPATH**/ ?>