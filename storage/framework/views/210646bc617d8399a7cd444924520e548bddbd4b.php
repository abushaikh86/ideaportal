...
if ($last_status <= 0) { $last_status=0; }
    ...
    ?>  <?php $__env->startSection('title', 'User Dashboard | View Idea' ); ?> <?php $__env->startSection('content'); ?>  <section class="cs-breadcrumb">
                            ...
                            <div class="col-lg-5 col-12">
                                <div class="position-sticky top-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="idea-status-box mb-2">
                                                <select class="form-select me-2" id="idea_status" name="idea_status">
                                                    ...
                                                    ?>
                                                    <option <?php echo e($idea['active_status']==$key ? 'selected' : ''); ?> <?php echo e($key=='in_assessment' ? 'disabled' : ''); ?> value="<?php echo e($key); ?>"><?php echo e($status_option); ?> <?php echo e($reason); ?>

                                                    </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <input type="hidden" value="<?php echo e($roles_external->role_type); ?>"
                                                    name="role">
                                            ...
                                            <div id="content">
                                                <input type="text" id="reason_sla" name="sla_reason"
                                                    ...
                                                    <?php if(isset($idea->sla_reason_approver) &&
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if(in_array($idea->active_status, ['under_approving_authority']) ||
                                                ...
                                                <form action="<?php echo e(route('ideaApproveWithbudget')); ?>" method="post"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <input type="hidden" value="<?php echo e($idea->idea_id); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <?php echo e(Form::select('expenses_approved_company',$company,
                                                    ...
                                                    <div class="col col-md-12 text-center">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php else: ?>
                                                        <?php if(isset($idea->approving_authority_approval) &&
                                                        $idea->approving_authority_approval == 1): ?>
                                                        <button type="button"
                                                            title="click here to change the status of the idea to Implemented"
                            ...
                            <div class="col-lg-7 col-12">
                                ...
                                <div class="list">
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            <p class="mb-3"><?php echo e(isset($idea->description) ? $idea->description : ''); ?>
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_idea_clarity', ['yes' => 'Yes', 'no' => 'No'],
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->idea_description) && $journey_approver->idea_description == 'like' ? 'active' : ''); ?>"
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->idea_description) && $journey_approver->idea_description == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_outcome', ['yes' => 'Yes', 'no' => 'No'],
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->outcome) && $journey_approver->outcome == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->outcome) && $journey_approver->outcome == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            <p class="mb-3"><?php echo e(isset($idea->why_implemented) ? $idea->why_implemented :
                                                ''); ?></p>
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_why_implemented', ['yes' => 'Yes', 'no' =>
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->why_implemented) && $journey_approver->why_implemented == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->why_implemented) && $journey_approver->why_implemented == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_challenges', ['yes' => 'Yes', 'no' => 'No'],
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->challenges) && $journey_approver->challenges == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->challenges) && $journey_approver->challenges == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_has_alternatives', ['yes' => 'Yes', 'no' =>
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->has_alternatives) && $journey_approver->has_alternatives == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->has_alternatives) && $journey_approver->has_alternatives == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            <p class="mb-3"><?php echo e(isset($idea->cost_and_benifits) ?
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('assessment_has_less_benifits', ['yes' => 'Yes', 'no' =>
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->has_less_benifits) && $journey_approver->has_less_benifits == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->has_less_benifits) && $journey_approver->has_less_benifits == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php if(strtolower($roles_external->role_type) == 'approving authority'): ?>
                                            <?php echo e(Form::select('benifits', ['yes' => 'Yes', 'no' => 'No'],
                                            ...
                                            <div class="action-btn">
                                                ...
                                                <!-- Add active class to button for selection -->
                                                <button
                                                    class="like-btn <?php echo e(isset($journey_approver->benifits) && $journey_approver->benifits == 'like' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                                ...
                                                <button
                                                    class="dislike-btn <?php echo e(isset($journey_approver->benifits) && $journey_approver->benifits == 'dislike' ? 'active' : ''); ?>"
                                                    data-idea-id="<?php echo e($idea->idea_id); ?>" data-user-id=<?php echo e($idea->user_id); ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            <?php if(isset($assessment_journey->remarks) &&
                                            !is_null($assessment_journey->remarks)): ?>
                                            <p class="mb-3">Assessment User Response <?php echo e($assessment_journey->remarks); ?>

                                            </p>
                                            <?php endif; ?>

                                            <?php echo e(Form::text('remarks',(isset($journey_approver->remarks)?$journey_approver->remarks:null),
...
<script>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ideaportal\resources\views/frontend/ideas/view_idea_approving_authority.blade.php ENDPATH**/ ?>